...
3. **workers.html** - List all workers on a single page
4. **order.html** - Page to Order Selected Food
5. **category_workers.html** - Page to list all the Foods based on Category Selected
6. **worker_search.html** - Page to list all the Foods based on Search keyword
